                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:void(0)">Campanhas</a></li>
                                    <li><a href="javascript:void(0)">Concessionários Dreams Rent</a></li>
                                    <li><a href="javascript:void(0)">Promoções e Incentivos</a></li>
                                    <li><a href="javascript:void(0)">Serviços Financeiros</a></li>
                                </ul>
                            </div>
                            <!-- /Widget Rodapé -->
                        </div>
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="testimonial.html">Testemunhos</a></li>
                ...
                <div class="row align-items-center row-gap-3">
                    <div class="col-lg-4">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2025 Dreams Rent. Todos os direitos reservados.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
